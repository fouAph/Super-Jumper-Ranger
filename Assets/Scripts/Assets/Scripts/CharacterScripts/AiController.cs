...
public class AiController : MonoBehaviour
{
    ...
    */
    ...
    private void Awake()
    {
        ...
        if (_pathScript == null) { _pathScript = GameObject.FindObjectOfType<Pathfinding>(); }
    ...
    public void PathCompleted()
    {
        switch (state)
        {
            case ai_state.pathfinding:
                // _behaviourText.text = "";
                break;
            case ai_state.pathfindChase:
                destroy = true;
                break; /*when character reaches house, destroy on next update*/
            case ai_state.chase:
